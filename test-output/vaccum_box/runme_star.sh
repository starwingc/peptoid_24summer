...
gmx grompp -f em.mdp -c 19AE1-4-A_protonated_boxed.gro -p 19AE1-4-A_protonated_GMX.top -n index.ndx -o em_vacuum.tpr -maxwarn 1

# Submit the energy minimization job to node
gmx mdrun -v -s em_vacuum.tpr -c em_vacuum.gro -o em_vacuum.trr

# Do an NVT in vacuum
gmx grompp -f nvt.mdp -c em_vacuum.gro -p 19AE1-4-A_protonated_GMX.top -n index.ndx -o nvt_vacuum.tpr -maxwarn 1
